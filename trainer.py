...
def train_model(model, optimizer, train_wavs, train_texts, test_wavs, test_texts, epochs=100, batch_size=50):
    ...
    with tf.device(device_name):
        ...
        for e in range(0, epochs + epochs):
            ...
            for  start in range(0, len_test, batch_size):
            ...
            rec = "Epoch: {}, Train Loss: {:.2f}, Test Loss {:.2f}, in {:.2f} secs.\n".format(e+1, train_loss, test_loss, time.time() - start_time )
...
if __name__ == "__main__":
    ...
    # Load the data
    print("Loading data.....")
    train_wavs, train_texts = load_data("dataset/wav_files(sampled)", "dataset/transcriptions(sampled)/file_speaker_text(sampled).csv")
    print("Data loaded \u2705 \u2705 \u2705 \u2705\n")
    ...
    """
    train_model(model, optimizer, train_wavs, train_texts, test_wavs, test_texts, epochs=100, batch_size=2)